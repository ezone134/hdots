...
Scope {
    ...
    readonly property string hyprConf: Quickshell.env("hypr_conf") || ("/tmp/" + (Quickshell.env("USER") || "tw") + "_hypr_conf")
    ...
    readonly property string hyprSources: Quickshell.env("hypr_sources") || (root.hyprConf + "/sources")
    ...
    readonly property string hyprCache: root.hyprConf + "/hypr_cache"
    ...
    function envExport() {
        ...
        return [
            ...
            "export hypr_conf=" + root.esc(root.hyprConf),
            "export hypr_log=" + root.esc(root.hyprConf + "/log"),
            "export lock_files=" + root.esc(root.hyprConf + "/lock_hold_files"),
            "export hypr_scripts=" + root.esc(root.hyprConf + "/scripts"),
            "export hypr_global=" + root.esc(root.hyprGlobal),
            "export hypr_cache=" + root.esc(root.hyprConf + "/hypr_cache"),
            "export states=" + root.esc(root.states),
            "export states2=" + root.esc(root.states2),
            "export hypr_temp=" + root.esc(root.hyprConf + "/hypr_temp"),
            "export hypr_sources=" + root.esc(root.hyprSources),
