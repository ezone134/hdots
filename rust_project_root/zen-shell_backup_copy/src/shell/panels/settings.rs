...
const NAV_NETWORK: u32 = 200;
const NAV_SOUND: u32 = 201;
const NAV_APPEARANCE: u32 = 202;
const NAV_PILL: u32 = 203;
const NAV_SYSTEM: u32 = 204;
const NAV_MISC: u32 = 219;

impl Shell {
    /// Draw the two-pane Settings scene.
    ...
    // ── Network & Internet ──
    fn layout_settings_network(&mut self, v: &mut Vec<Cmd>, w: f32, cx: f32, pal: &Pal) {
    ...
    // ── Sound & Display ──
    fn layout_settings_sound(&mut self, v: &mut Vec<Cmd>, w: f32, cx: f32, pal: &Pal) {
    ...
    // ── Appearance ──
    fn layout_settings_appearance(&mut self, v: &mut Vec<Cmd>, w: f32, cx: f32, pal: &Pal) {
        ...
        // ---- ACCENT SOURCE (writes $states/acc_source_<ch> via theme_main) ----
        ...
        let src_rows: [(u32, &str, &str, &str); 3] = [
            ...
            (61, ICON_PALETTE, "Scheme default", "d"),
    ...
    // ── Pill ──
    fn layout_settings_pill(&mut self, v: &mut Vec<Cmd>, w: f32, cx: f32, pal: &Pal) {
    ...
    // ── System ──
    fn layout_settings_system(&mut self, v: &mut Vec<Cmd>, w: f32, cx: f32, h: f32, pal: &Pal) {
    ...
    // ── Misc ──
    fn layout_settings_misc(&mut self, v: &mut Vec<Cmd>, w: f32, cx: f32, pal: &Pal) {
