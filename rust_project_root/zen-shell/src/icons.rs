...
/// view_list — Custom-Accent card list-view toggle.
pub const ICON_LIST: &'static str = "\u{e8ef}";
...
mod tests {
    ...
    fn codepoints_are_private_use() {
        let all = [
            ...
            ICON_SETTINGS_FILL, ICON_SWAP, ICON_CALENDAR_FILL, ICON_GRID, ICON_LIST, ICON_SPEED_FILL,
